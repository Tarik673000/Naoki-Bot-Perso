...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (img == null) img = "https://i.imgur.com/KUQ8Q2C.gif"
        ...
        if (args[0] === "all") {
            ...
            const imgperm = "https://cdn.discordapp.com/attachments/904084986536276059/1004761057056805024/standard_9.gif"
    ...
    **\`${pf}setname\`**
    Permet de changer le nom du bot
        ...
        if (helpm == 'help') {
            ...
            const Help = new Discord.MessageEmbed()
                .setTitle(`${emote.utilitaire.information}・Panel d'aide de ${client.user.username}`)
                .setDescription(`${emote.utilitaire.coin}・Ce bot appartient à <@${config.app.owners}>`)
                .setImage(img)
                .setColor(color)
                .setFooter({ text: `${footer} | Prefix actuel : ${pf}` })
