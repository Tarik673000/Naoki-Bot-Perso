...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        //hétéros
        if (member == '844105338386776094') return message.channel.send({ embeds: [notgay] }) //Funny
        if (member == '890165529501913108') return message.channel.send({ embeds: [notgay] }) //Mizuke
        //Les pd
